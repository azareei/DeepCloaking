function [S_energy]=function_cloaking(NP,parameter)


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%cylinder is srrounded by circular elastic plates for cloaking
%%%wave numbers are positive real velues (except for damped waves)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
NMI=20; % number of modes in theta direction for incident wave
NI=NP/2; % number of layers MAX=NT
...
gamma=parameter(1:NI);
beta=parameter(NI+1:2*NI);
